...
public class BsServer {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(BsServer.class);
    ...
    public static void createAndStartServer(String webAddress, int webPort, String localAddress, int localPort,
        ...
        root.setContextPath("/");
        root.setResourceBase(BsServer.class.getClassLoader().getResource("webapp").toExternalForm());
